module github.com/cloudoperators/opentelemetry-collector-contrib/internal/kafka
...
require (
	...
	go.opentelemetry.io/collector/config/configcompression v1.50.1-0.20260121161034-55399d4743af
